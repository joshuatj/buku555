...
CREATE TABLE `user` (
  ...
  `receive_notimail` BIT NULL DEFAULT 1,
...
CREATE TABLE `bill_splitees` (
  ...
  `amount_to_pay` DOUBLE NULL DEFAULT NULL,
...
INSERT INTO `buku555`.`item_type` (`item_type_name`) VALUES ('Electronic Devices');
INSERT INTO `buku555`.`item_type` (`item_type_name`) VALUES ('Clothes');
INSERT INTO `buku555`.`item_type` (`item_type_name`) VALUES ('Others');
