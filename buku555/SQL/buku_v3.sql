...
DROP DATABASE IF EXISTS buku3;
CREATE DATABASE IF NOT EXISTS buku3;
USE buku3;
...
INSERT INTO `buku3`.`user` (`fb_user_id`, `email`, `isRegistered`) VALUES ('11111', 'ducnq135@facebook.com', 1);
INSERT INTO `buku3`.`user` (`fb_user_id`, `email`, `isRegistered`) VALUES ('22222', 'abc@facebook.com', 1);
INSERT INTO `buku3`.`user` (`fb_user_id`, `email`) VALUES ('33333', 'def@fb.com');

INSERT INTO `buku3`.`Bill` (`owner_user_id`, `date`, `total_amount`, `reason`) VALUES ('1', '2013-1-1', '300', 'for test');

INSERT INTO `buku3`.`item_type` (`item_type_name`) VALUES ('Book');
INSERT INTO `buku3`.`item_type` (`item_type_name`) VALUES ('CD');
INSERT INTO `buku3`.`item_type` (`item_type_name`) VALUES ('Phone');
...
INSERT INTO `buku3`.`bill_splitees` (`user_id`, `amount_to_pay`, `currency_id`, `bill_id`) VALUES ('2', '100', '1', '1');
INSERT INTO `buku3`.`bill_splitees` (`user_id`, `amount_to_pay`, `currency_id`, `bill_id`) VALUES ('3', '100', '1', '1');